...
export default function LoginForm() {
    return(
        <div className="bg-xuntaGris-50 md:flex mx-10 mt-12 md:mt-32 border border-black rounded-md overflow-hidden lg:w-1/2 lg:mx-auto">
            <div className="md:w-1/2 mx-2 mt-4 mb-6">
            ...
            <div className="hidden md:flex bg-blue-50 md:w-1/2 text-center align-middle flex-col py-9 px-5">
            <img src={logoPath} className="h-18 m-auto mb-10"/>
