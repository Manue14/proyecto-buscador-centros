...
export default function LoginForm({ method, action }) {
    return(
        <div className="bg-xuntaGris-50 md:flex mx-10 mt-12 md:mt-24 border border-black rounded-md overflow-hidden md:h-[50vh] lg:h-[50vh] lg:w-1/2 lg:mx-auto">
            <div className="md:w-1/2 mx-2 mt-4 mb-6 md:flex md:flex-col md:place-content-center">
                ...
                <form className="flex flex-col" method={method} action={action}>
                    <input id="email" name="email" type="text" placeholder="Correo de xunta" className="mb-7 p-3 mx-3 border-b border-xuntaGris-100 bg-slate-50 focus:outline-none focus:bg-xuntaAzul-50 focus:border-xuntaAzul-200" required></input>
                    <input id="pswd" name="pswd" type="password" placeholder="Contrasinal" className="mb-7 p-3 mx-3 border-b border-xuntaGris-100 bg-slate-50 focus:outline-none focus:bg-xuntaAzul-50 focus:border-xuntaAzul-200" required></input>
                    <PrimaryButton color="xuntaAzul">Iniciar sesión</PrimaryButton>
                </form>
            </div>
