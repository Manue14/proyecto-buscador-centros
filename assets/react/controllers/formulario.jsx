...
export default function MyForm({ action, concellos }) {
    ...
    return (
        <form id="searchForm" className="lg:text-xl xl:text-2xl w-full" method="get" action={action}>
            ...
            <fieldset className="p-4 bg-xuntaGris-100 rounded-md">
                ...
                <div className="flex flex-col mb-5">
                <label htmlFor="tipo_centro">Tipos de Centro</label>
                ...
                <div>
                    ...
                    <select className="rounded-md w-4/5 md:w-3/6" id="titularidad" name="titularidad">
                        <option value="">--Todas--</option>
